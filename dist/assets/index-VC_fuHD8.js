(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();const Le="https://iyznlhahblpjczjzmscy.supabase.co",Ce="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5em5saGFoYmxwamN6anptc2N5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNDg5MzQsImV4cCI6MjEwMjcyNDkzNH0.gnVzB1be9lfv2ylqqz6bSLiakv01YwXuXxNVF47VhHA";supabase.createClient(Le,Ce);let R=null;function S(){if(!R){const e=localStorage.getItem("adeffect_auth_user");if(e)try{R=JSON.parse(e)}catch{}}return R}function te(e){R=e,e?localStorage.setItem("adeffect_auth_user",JSON.stringify(e)):localStorage.removeItem("adeffect_auth_user"),window.dispatchEvent(new CustomEvent("authChange",{detail:{user:e}}))}function ke(){const e=document.getElementById("btnGoToDashboard"),t=document.getElementById("btnForgotPassword");t&&t.addEventListener("click",r=>{r.preventDefault(),Fe()}),e&&e.addEventListener("click",r=>{r.preventDefault(),De()});const n=document.getElementById("signUpForm");n&&n.addEventListener("submit",$e);const i=document.getElementById("signInForm");i&&i.addEventListener("submit",Ae);const o=document.getElementById("btnHeaderLogin");o&&o.addEventListener("click",r=>{r.preventDefault(),G("signin")});const a=document.getElementById("btnSwitchToSignUp");a&&a.addEventListener("click",r=>{r.preventDefault(),G("signup")}),new URLSearchParams(window.location.search).get("reset")==="true"&&(_("authSection"),G("signin"),ne("You can now set a new password — Supabase handles this via your account settings page.")),_("home")}async function Fe(){var n;const e=(n=document.getElementById("signinEmail"))==null?void 0:n.value.trim();if(!e){L('Please enter your email address above, then click "Forgot your password?"');return}const t=x();if(!t){L("Unable to connect. Please try again later.");return}try{const{error:i}=await t.auth.resetPasswordForEmail(e,{redirectTo:window.location.origin+"/?reset=true"});if(i){L(`Could not send reset email: ${i.message}`);return}ne("Password reset email sent! Check your inbox and follow the link.")}catch(i){L("Something went wrong. Please try again."),console.error("Forgot password error:",i)}}function De(){const e=S();e&&e.status==="verified"?_("dashboardSection"):_("authSection")}function G(e){const t=document.getElementById("signUpBox"),n=document.getElementById("signInBox"),i=document.getElementById("btnHeaderLogin");e==="signin"?(t&&(t.style.display="none"),n&&(n.style.display="block"),i&&(i.textContent="SIGN UP")):(t&&(t.style.display="block"),n&&(n.style.display="none"),i&&(i.textContent="LOG IN"))}async function Ae(e){var d,g,y;e.preventDefault();const t=(d=document.getElementById("signinEmail"))==null?void 0:d.value.trim(),n=(g=document.getElementById("signinPassword"))==null?void 0:g.value.trim(),i=document.getElementById("signInErrorBox"),o=document.getElementById("signInSuccessBox");if(i&&(i.style.display="none"),o&&(o.style.display="none"),!t||!n){L("Please enter both your email address and password.");return}const a=x();let s=null;if(a)try{const{data:u,error:E}=await a.auth.signInWithPassword({email:t,password:n});if(E){L(E.message||"Invalid email or password.");return}if(u&&u.user){const p=((y=u.user.user_metadata)==null?void 0:y.full_name)||u.user.email.split("@")[0];s={id:u.user.id,email:u.user.email,name:p,status:"verified"}}else{L("Authentication failed. Please check your credentials.");return}}catch(u){console.error("Supabase auth exception:",u),L("An error occurred during authentication. Please try again.");return}else{L("Authentication service is unavailable. Please try again later.");return}te(s),ne("Login successful! Redirecting to your Client Dashboard...");const r=document.getElementById("dashboardGreetingName");r&&(r.textContent=`Hello, ${s.name}`);const l=document.getElementById("sidebarProfileName");l&&(l.textContent=s.name);const c=document.getElementById("signInForm");c&&c.reset(),setTimeout(()=>{o&&(o.style.display="none"),_("dashboardSection")},1e3)}function L(e){let t=document.getElementById("signInErrorBox");if(!t){const n=document.getElementById("signInForm");n&&(t=document.createElement("div"),t.id="signInErrorBox",t.style.cssText="background: #FEF2F2; border: 2px solid #EF4444; color: #991B1B; padding: 12px 16px; border-radius: 12px; font-weight: 700; font-size: 0.9rem; margin-bottom: 16px;",n.prepend(t))}t?(t.textContent=e,t.style.display="block"):alert(e)}function ne(e){let t=document.getElementById("signInSuccessBox");if(!t){const n=document.getElementById("signInForm");n&&(t=document.createElement("div"),t.id="signInSuccessBox",t.style.cssText="background: #DCFCE7; border: 2px solid #16A34A; color: #15803D; padding: 12px 16px; border-radius: 12px; font-weight: 700; font-size: 0.9rem; margin-bottom: 16px;",n.prepend(t))}t?(t.textContent=e,t.style.display="block"):alert(e)}async function $e(e){var u,E,p,I,f,D,w,v;e.preventDefault();const t=(u=document.getElementById("signupName"))==null?void 0:u.value.trim(),n=(E=document.getElementById("signupBusiness"))==null?void 0:E.value.trim(),i=(p=document.getElementById("signupEmail"))==null?void 0:p.value.trim(),o=(I=document.getElementById("signupWebsite"))==null?void 0:I.value.trim(),a=(f=document.getElementById("signupPhone"))==null?void 0:f.value.trim(),s=(D=document.getElementById("signupLocation"))==null?void 0:D.value.trim(),r=(w=document.getElementById("signupPassword"))==null?void 0:w.value.trim(),l=(v=document.getElementById("signupConfirmPassword"))==null?void 0:v.value.trim(),c=document.querySelectorAll('input[name="hear_about_us"]:checked'),d=Array.from(c).map(m=>m.value);if(!t||!n||!i||!a||!r||!l){alert("Please fill out all required fields.");return}if(r!==l){alert("Passwords do not match. Please re-enter your password.");return}if(r.length<6){alert("Password must be at least 6 characters long.");return}const g={user_name:t,business_name:n,email:i,website:o,phone_number:a,location:s,password:r,hear_about_us:d},y=document.getElementById("btnSignUpSubmit");y&&(y.disabled=!0,y.textContent="CREATING ACCOUNT...");try{const m=await Me(g);if(m.success){if(m.user){te(m.user);const N=document.getElementById("dashboardGreetingName");N&&(N.textContent=`Hello, ${m.user.name}`);const U=document.getElementById("sidebarProfileName");U&&(U.textContent=m.user.name)}const B=document.getElementById("signUpForm");B&&B.reset();const T=document.getElementById("pendingSuccessModal");T?T.classList.add("active"):_("dashboardSection")}else alert(m.error||"Failed to create account. Please try again.")}catch(m){console.error("Sign up error:",m),alert("An unexpected error occurred during sign up.")}finally{y&&(y.disabled=!1,y.textContent="SIGN UP")}}function _(e){const t=["home","about","services","projects","led-screen","contact"],n=["discoverySection","authSection","dashboardSection","careers"];if(e&&e.startsWith("#")&&(e=e.substring(1)),e==="dashboardSection"){const i=S();(!i||i.status!=="verified")&&(e="authSection")}n.includes(e)?(t.forEach(i=>{const o=document.getElementById(i);o&&o.style.setProperty("display","none","important")}),n.forEach(i=>{const o=document.getElementById(i);if(o)if(i===e){const a=i==="dashboardSection"?"flex":"block";o.style.setProperty("display",a,"important")}else o.style.setProperty("display","none","important")}),e==="dashboardSection"&&window.dispatchEvent(new CustomEvent("authChange")),window.scrollTo({top:0,behavior:"smooth"})):(n.forEach(i=>{const o=document.getElementById(i);o&&o.style.setProperty("display","none","important")}),t.forEach(i=>{const o=document.getElementById(i);o&&o.style.setProperty("display","block","important")}))}const ye={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_SUPABASE_ANON_KEY:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5em5saGFoYmxwamN6anptc2N5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNDg5MzQsImV4cCI6MjEwMjcyNDkzNH0.gnVzB1be9lfv2ylqqz6bSLiakv01YwXuXxNVF47VhHA",VITE_SUPABASE_URL:"https://iyznlhahblpjczjzmscy.supabase.co"},ze=typeof import.meta<"u"&&import.meta&&ye&&"https://iyznlhahblpjczjzmscy.supabase.co"||"https://iyznlhahblpjczjzmscy.supabase.co",j=ze.replace(/\/rest\/v1\/?$/,"").replace(/\/+$/,""),H=typeof import.meta<"u"&&import.meta&&ye&&"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5em5saGFoYmxwamN6anptc2N5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNDg5MzQsImV4cCI6MjEwMjcyNDkzNH0.gnVzB1be9lfv2ylqqz6bSLiakv01YwXuXxNVF47VhHA"||"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5em5saGFoYmxwamN6anptc2N5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNDg5MzQsImV4cCI6MjEwMjcyNDkzNH0.gnVzB1be9lfv2ylqqz6bSLiakv01YwXuXxNVF47VhHA";let W=null;function x(){if(typeof window<"u"&&!W&&window.supabase&&j&&H&&!j.includes("your-supabase-project-id"))try{W=window.supabase.createClient(j,H)}catch(e){console.warn("Supabase initialization warning:",e)}return W}function Q(e){return Array.isArray(e)?e.map(t=>{let n=t.price;typeof t.price=="number"?n=`$ ${t.price.toLocaleString()}`:t.price&&!t.price.toString().startsWith("$")&&(n=`$ ${t.price}`);let i=t.is_available;return typeof t.is_available=="boolean"?i=t.is_available?"Available":"Unavailable":t.is_available||(i="Available"),{...t,id:t.id||t.billboard_id,billboard_id:t.billboard_id||`BB-${t.id}`,location:t.location||"Tripoli Entrance & Avenue",maps_url:t.maps_url||"https://maps.google.com/?q=Tripoli,Lebanon",size:t.size||"Standard Size",price:n||"$ 1,000",numericPrice:typeof t.price=="number"?t.price:parseFloat((t.price||"").toString().replace(/[^0-9.]/g,""))||0,image_url:t.image_url||"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80",type:t.structure||"Unipole",is_available:i,available_until:t.available_until||null}}):[]}const se=[{billboard_id:"U002-A",location:"Bahsas, Tripoli Entrance",maps_url:"https://www.google.com/maps/place/Ad+effect/data=!4m2!3m1!1s0x0:0x1c8a54b37c14fbfc?sa=X&ved=1t:2428&ictx=111",size:"W:147 - H:43",price:"$ 1,000",image_url:"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80",type:"Unipole",is_available:"Available",available_until:null},{billboard_id:"U002-B",location:"Bahsas, Tripoli Entrance",maps_url:"https://maps.google.com/maps?q=34.396779039964066,35.79991279815192",size:"W: 40 - H: 30",price:"$ 1,200",image_url:"https://images.unsplash.com/photo-1568992687947-868a62a9f521?auto=format&fit=crop&w=800&q=80",type:"Unipole",is_available:"Available Soon",available_until:"2026-09-01"},{billboard_id:"P003-C",location:"Mina Road, Tripoli",maps_url:"https://maps.google.com",size:"3:4",price:"$ 600",image_url:"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80",type:"Portrait Billboard",is_available:"Available",available_until:null}];function P(e,t){try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}}function ie(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(n){console.error("Error saving local state:",n)}}async function Y(){const e=x();if(e)try{const{data:n,error:i}=await e.from("billboards").select("*");if(!i&&n&&n.length>0)return Q(n);i&&console.warn("Supabase JS Client error:",i.message)}catch(n){console.warn("Supabase JS Client fetch failed, trying direct REST fetch:",n)}try{const n=await fetch(`${j}/rest/v1/billboards?select=*`,{headers:{apikey:H,Authorization:`Bearer ${H}`}});if(n.ok){const i=await n.json();if(Array.isArray(i)&&i.length>0)return Q(i)}else console.warn("Direct REST fetch returned status:",n.status)}catch(n){console.warn("Direct REST fetch exception:",n)}let t=P("adeffect_billboards",null);return t||(ie("adeffect_billboards",se),t=se),Q(t)}async function Me(e){var o;const t=x();let n=null;if(t)try{const{data:a,error:s}=await t.auth.signUp({email:e.email,password:e.password,options:{data:{full_name:e.user_name,business_name:e.business_name}}});if(s)return{success:!1,error:s.message};n=(o=a==null?void 0:a.user)==null?void 0:o.id;const r={user_id:n,user_name:e.user_name,business_name:e.business_name,email:e.email,website:e.website||"",phone_number:e.phone_number,location:e.location||"",hear_about_us:e.hear_about_us||[],created_at:new Date().toISOString()},{error:l}=await t.from("users").insert([r]);return l&&console.warn("Supabase insert users warning:",l),le(r),{success:!0,user:{id:n,email:e.email,name:e.user_name,status:"verified"}}}catch(a){return console.error("Supabase sign up exception:",a),{success:!1,error:a.message||"An error occurred during sign up."}}n=`user-${Date.now()}`;const i={id:n,user_name:e.user_name,name:e.user_name,business_name:e.business_name,email:e.email,website:e.website||"",phone_number:e.phone_number,location:e.location||"",hear_about_us:e.hear_about_us||[],created_at:new Date().toISOString()};return le(i),{success:!0,user:{id:n,email:e.email,name:e.user_name,status:"verified"}}}function le(e){const t=P("adeffect_users",[]);t.push(e),ie("adeffect_users",t)}async function Pe(e){const t=e.name.split(".").pop(),i=`${`${Date.now()}_${Math.random().toString(36).substring(2,7)}.${t}`}`,o=x();if(o)try{const{data:s,error:r}=await o.storage.from("Briefs of Pending Requests").upload(i,e);if(!r&&s){const{data:l}=o.storage.from("Briefs of Pending Requests").getPublicUrl(i);return{success:!0,url:l.publicUrl,filename:e.name}}console.warn("Supabase Storage upload warning:",r)}catch(s){console.warn("Supabase Storage upload exception:",s)}return{success:!0,url:URL.createObjectURL(e),filename:e.name,isLocalFallback:!0}}async function Te(e){const t=S();if(!document.getElementById("performancesGrid"))return;t&&t.id;const i={user_id:t.id,user_email:e.user_email,billboard_id:e.billboard_id,start_time:e.start_time,end_time:e.end_time,brief_url:e.brief_url,extra_services:e.extra_services||[],status:"In Review",created_at:new Date().toISOString()},o=x();if(o)try{const{data:a,error:s}=await o.from("pending_bookings").insert([i]).select();if(!s)return ce(i),{success:!0,data:a};console.warn("Supabase insert pending_bookings warning:",s)}catch(a){console.warn("Supabase insert pending_bookings exception:",a)}return ce(i),{success:!0,data:[i]}}function ce(e){const t=P("adeffect_pending_bookings",[]);t.unshift(e),ie("adeffect_pending_bookings",t)}async function oe(e=null){const t=x();if(t)try{let i=t.from("pending_bookings").select("*");e&&(i=i.eq("user_email",e));const{data:o,error:a}=await i;if(!a&&o)return o}catch(i){console.warn("Supabase fetch pending_bookings error:",i)}const n=P("adeffect_pending_bookings",[]);return e?n.filter(i=>i.user_email===e):n}async function ve(e){const t=x();let n=[];if(t)try{let i=t.from("bookings").select("*");e&&(i=i.eq("billboard_id",e));const{data:o,error:a}=await i;!a&&o&&(n=o)}catch(i){console.warn("Supabase fetch bookings error:",i)}if(n.length===0){const i=P("adeffect_confirmed_bookings",[{id:101,client_id:"user-sample-id",billboard_id:"U002-A",start_time:"2026-09-01T00:00:00.000Z",end_time:"2026-09-15T00:00:00.000Z",is_active:!0,created_at:"2026-08-01T00:00:00.000Z"}]);n=e?i.filter(o=>o.billboard_id===e):i}return n}async function Ne(e,t,n,i=null){const o=new Date(t).getTime(),a=new Date(n).getTime();if(isNaN(o)||isNaN(a)||o>=a)return{valid:!1,message:"Start date must be before end date."};const s=new Date(t),r=new Date(n),l=r.getTime()-s.getTime(),c=Math.round(l/(1e3*60*60*24)),d=(i||"").toString().toLowerCase().replace(/\s+/g,"");if(d.includes("3:4")||d.includes("3x4")||d.includes("3/4")){if(c<7)return{valid:!1,message:"Billboards of size 3:4 require a minimum booking period of 1 week (7 days)."}}else{const p=new Date(s);if(p.setMonth(p.getMonth()+1),c<28&&r<p)return{valid:!1,message:"Billboards must be booked for a minimum period of 1 month."}}const y=await oe(),u=await ve(e),E=[...y.filter(p=>p.billboard_id===e&&p.status!=="Rejected"),...u.filter(p=>p.billboard_id===e)];for(const p of E){const I=new Date(p.start_time||p.start_date).getTime(),f=new Date(p.end_time||p.end_date).getTime();if(!isNaN(I)&&!isNaN(f)&&o<=f&&a>=I)return{valid:!1,message:"Selected timeframe overlaps with an existing booking for this billboard. Please choose another date range."}}return{valid:!0}}async function Ue(e=null){const t=x();if(!t||!e)return[];try{const{data:n,error:i}=await t.from("bookings").select("*, billboards(*)").eq("is_active",!0).eq("user_id",e);return i?(console.error("Supabase fetch active bookings error:",i.message),[]):n||[]}catch(n){return console.warn("Supabase fetch active bookings exception:",n),[]}}async function qe(e,t=null){const n=x();if(n)try{let o=n.from("quotations").select("*");e&&(o=o.eq("client_id",e));const{data:a,error:s}=await o;if(!s&&a)return a}catch(o){console.warn("Supabase fetch quotations error:",o)}return P("adeffect_quotations",[{id:501,created_at:new Date().toISOString(),client_id:e||"client-uuid-001",client_name:"AdEffect Client",media_type:"Outdoor Unipole",media_used:"Backlit Vinyl Print",reference:"U002-A",media_location:"Bahsas, Tripoli Entrance",frequency:1,period:"1 Month (Aug 2026)",printing_cost:250,total_cost_wo_printing:1e3,total_cost_with_printing:1250},{id:502,created_at:new Date(Date.now()-864e5*5).toISOString(),client_id:e||"client-uuid-001",client_name:"AdEffect Client",media_type:"Megapole Network",media_used:"Frontlit Flex Banner",reference:"U002-B",media_location:"Dam & Farz Highway",frequency:2,period:"2 Months (Sep-Oct 2026)",printing_cost:400,total_cost_wo_printing:2400,total_cost_with_printing:2800}])}function Oe(){const e=document.getElementById("dotsContainer"),t=document.querySelectorAll(".dot"),n=document.getElementById("logoText"),i=document.getElementById("sloganText"),o=document.getElementById("brandAssembly"),a=document.getElementById("heroAnimationStage"),s=document.getElementById("replayBtn"),r=document.querySelectorAll(".hero-slide"),l=document.querySelectorAll(".slide-dot"),c=document.getElementById("heroProgressFill");let d=0,g=null;const y=4500;function u(){const v=document.getElementById("billboardStreamUp"),m=document.getElementById("billboardStreamDown");!v||!m||Y().then(B=>{const T=B&&B.length?B:[{billboard_id:"U002-A",location:"Bahsas, Tripoli Entrance",image_url:"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80"},{billboard_id:"U002-B",location:"Dam & Farz Highway",image_url:"https://images.unsplash.com/photo-1568992687947-868a62a9f521?auto=format&fit=crop&w=800&q=80"},{billboard_id:"P003-C",location:"Mina Road, Tripoli",image_url:"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80"}],N=(C,q)=>`
      ...
      `,U=T.map((C,q)=>N(C,q)).join(""),re=[...T].reverse().map((C,q)=>N(C,q+1)).join("");v.innerHTML=U+U,m.innerHTML=re+re})}function E(){e==null||e.classList.remove("vertical"),n==null||n.classList.remove("show"),i==null||i.classList.remove("typing"),o==null||o.classList.remove("shifted-up"),a==null||a.classList.remove("show"),t.forEach(v=>{v.classList.remove("pop-1","pop-2","pop-3"),v.style.opacity="0",v.style.transform="scale(0)"}),setTimeout(()=>{t[0]&&t[0].classList.add("pop-1"),t[1]&&t[1].classList.add("pop-2"),t[2]&&t[2].classList.add("pop-3")},100),setTimeout(()=>{e==null||e.classList.add("vertical"),n==null||n.classList.add("show"),i==null||i.classList.add("typing")},750),setTimeout(()=>{o==null||o.classList.add("shifted-up"),a==null||a.classList.add("show"),D()},1450)}function p(v){r.length&&(d=(v+r.length)%r.length,r.forEach((m,B)=>{B===d?m.classList.add("active"):m.classList.remove("active")}),l.forEach((m,B)=>{B===d?m.classList.add("active"):m.classList.remove("active")}),I())}function I(){c&&(c.style.transition="none",c.style.width="0%",c.offsetWidth,c.style.transition=`width ${y}ms linear`,c.style.width="100%")}function f(){p(d+1)}function D(){w(),p(0),g=setInterval(f,y)}function w(){g&&(clearInterval(g),g=null)}l.forEach(v=>{v.addEventListener("click",()=>{const m=parseInt(v.getAttribute("data-slide-index")||"0",10);w(),p(m),g=setInterval(f,y)})}),u(),E(),s&&s.addEventListener("click",()=>{w(),E()})}function Re(){const e=document.getElementById("carouselTrack");if(!e)return;Array.from(e.children).forEach(s=>{const r=s.cloneNode(!0);e.appendChild(r)});let n=0;const i=1.2,o=e.scrollWidth/2;function a(){n+=i,n>=o&&(n=0),e.style.transform=`translateX(-${n}px)`;const s=window.innerWidth/2,r=e.querySelectorAll(".carousel-item");let l=null,c=1/0;r.forEach(d=>{const g=d.getBoundingClientRect(),y=g.left+g.width/2,u=Math.abs(s-y);d.classList.remove("active-center"),u<c&&(c=u,l=d)}),l&&c<220&&l.classList.add("active-center"),requestAnimationFrame(a)}requestAnimationFrame(a)}const je={billboards:{title:"Billboards",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="4" width="18" height="12" rx="2"/><path d="M7 16v4M17 16v4M12 16v4"/><path d="M4 8h16"/></svg>',body:`
      <ol>
...
Print advertising: Ad Effect Company can assist in all printing services for the outdoor media printings, from small to large printing.</p>
    ...
    `}};function He(){const e=document.querySelectorAll(".service-item"),t=document.getElementById("serviceCardTitle"),n=document.getElementById("serviceCardIcon"),i=document.getElementById("serviceCardBody");e.length&&e.forEach(o=>{o.addEventListener("click",()=>{const a=o.getAttribute("data-service"),s=je[a];s&&(e.forEach(r=>r.classList.remove("active")),o.classList.add("active"),t&&(t.textContent=s.title),n&&(n.innerHTML=s.icon),i&&(i.innerHTML=s.body))})})}function Je(){const e=document.querySelectorAll(".project-card"),t=document.getElementById("projects");if(!t||!e.length)return;const n={root:null,threshold:.15};new IntersectionObserver(o=>{o.forEach(a=>{a.isIntersecting&&e.forEach((s,r)=>{setTimeout(()=>{s.classList.add("pop-in")},r*120)})})},n).observe(t)}function Ve(){const e=document.getElementById("led-screen"),t=document.getElementById("ledPage1"),n=document.getElementById("ledPage2");if(!e||!t||!n)return;let i=!1;function o(){const s=e.getBoundingClientRect(),r=window.innerHeight,l=e.offsetHeight-r;if(l<=0){i=!1;return}let d=-s.top/l;d=Math.max(0,Math.min(1,d));const g=-d*100,y=(1-d)*100;t.style.transform=`translate3d(0, ${g}vh, 0)`,n.style.transform=`translate3d(0, ${y}vh, 0)`,t.style.opacity=d>.85?(1-d)/.15:1,n.style.opacity=d<.15?d/.15:1,i=!1}function a(){i||(requestAnimationFrame(o),i=!0)}window.addEventListener("scroll",a,{passive:!0}),window.addEventListener("resize",a,{passive:!0}),o()}function Ge(){const e=document.getElementById("contactForm"),t=document.getElementById("contactEmail"),n=document.getElementById("contactMessage"),i=document.getElementById("emailError"),o=document.getElementById("messageError");if(!e)return;function a(s){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(s).toLowerCase())}e.addEventListener("submit",s=>{s.preventDefault();let r=!0;i.classList.remove("show"),o.classList.remove("show");const l=t.value.trim(),c=n.value.trim();if((!l||!a(l))&&(i.textContent="Please enter a valid email address.",i.classList.add("show"),r=!1),c||(o.textContent="Please write a message before sending.",o.classList.add("show"),r=!1),r){const d="Reservation@ad-effect.com",g=encodeURIComponent("New Ad Effect Website Inquiry"),y=encodeURIComponent(`From: ${l}

Message:
${c}`),u=`mailto:${d}?subject=${g}&body=${y}`;window.location.href=u,alert("Thank you! Opening your email client to send your message to ssamadmiryam@gmail.com."),e.reset()}})}let A=[],k=[];function We(){window.addEventListener("authChange",de),de();const e=document.querySelectorAll(".sidebar-link");e.forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),e.forEach(c=>c.classList.remove("active")),s.classList.add("active");const l=s.getAttribute("data-tab");Qe(l)})});const t=document.getElementById("sidebarLogoutBtn");t&&t.addEventListener("click",()=>{te(null),_("home")});const n=document.getElementById("btnNewBillboardRequest");n&&n.addEventListener("click",s=>{s.preventDefault(),_("discoverySection")});const i=document.getElementById("btnCloseQuotationModal");i&&i.addEventListener("click",()=>{const s=document.getElementById("quotationModal");s&&s.classList.remove("active")});const o=document.getElementById("btnCloseActiveModal");o&&o.addEventListener("click",()=>{const s=document.getElementById("activeBillboardModal");s&&s.classList.remove("active")});const a=document.getElementById("btnConvertToPDF");a&&a.addEventListener("click",Ke)}function de(){const e=S(),t=document.getElementById("dashboardGreetingName"),n=document.getElementById("sidebarProfileName");e?(t&&(t.textContent=`Hello, ${e.name||"Client"}`),n&&(n.textContent=e.name||"Client Account")):(t&&(t.textContent="Hello, Client"),n&&(n.textContent="Client Profile")),be(),ae(),he()}function Qe(e){const t=document.getElementById("dashTabMain"),n=document.getElementById("dashTabRequests"),i=document.getElementById("dashTabActiveBillboards"),o=document.getElementById("dashTabQuotations");t&&(t.style.display="none"),n&&(n.style.display="none"),i&&(i.style.display="none"),o&&(o.style.display="none"),e==="requests"&&n?(n.style.display="block",ae()):e==="active"&&i?(i.style.display="block",Xe()):e==="quotations"&&o?(o.style.display="block",he()):t&&(t.style.display="block",be())}async function be(){const e=S(),t=document.getElementById("performancesGrid");if(!t)return;const n=e?e.id:null;if(k=await Ue(n),!k||k.length===0){t.innerHTML=`
    ...
    `}).join(""),t.querySelectorAll(".active-perf-card").forEach(i=>{i.addEventListener("click",()=>{const o=i.getAttribute("data-booking-id"),a=k.find(s=>String(s.id)===String(o));a&&Ye(a)})})}function Xe(){const e=document.getElementById("activeBillboardsGrid");if(e){if(!k||k.length===0){e.innerHTML=`
      <div style="grid-column: 1 / -1; text-align: center; padding: 32px; background: #FFFFFF; border-radius: 16px; border: 2px dashed #ccc;">
  ...
  `,t.classList.add("active")}async function ae(){const e=S(),t=document.getElementById("dashboardRequestsTableBody");if(!t)return;const n=e?e.email:null,i=await oe(n);if(!i||i.length===0){t.innerHTML=`
    ...
    `}).join("")}async function he(){const e=S(),t=document.getElementById("quotationsGrid");if(!t)return;const n=e?e.id||e.email:null;if(A=await qe(n,e?e.email:null),!A||A.length===0){t.innerHTML=`
      <div style="grid-column: 1 / -1; text-align: center; padding: 32px; background: #FFFFFF; border-radius: 16px; border: 2px dashed #ccc;">
  ...
  `,t.classList.add("active")}function Ke(){window.print()}let F=null,b={billboard_id:"",start_time:"",end_time:"",brief_url:"",brief_filename:"",extra_services:[]},$=new Date,we=[];function et(){const e=document.getElementById("btnDetailBookNow");e&&e.addEventListener("click",()=>nt());const t=document.getElementById("bookingStartDate"),n=document.getElementById("bookingEndDate");t&&t.addEventListener("change",Z),n&&n.addEventListener("change",Z);const i=document.getElementById("calPrevMonth"),o=document.getElementById("calNextMonth");i&&i.addEventListener("click",()=>{$.setMonth($.getMonth()-1),J()}),o&&o.addEventListener("click",()=>{$.setMonth($.getMonth()+1),J()});const a=document.getElementById("btnStep1Next");a&&a.addEventListener("click",it),ot();const s=document.getElementById("btnStep2Next");s&&s.addEventListener("click",at),rt();const r=document.getElementById("btnStep3Next");r&&r.addEventListener("click",st);const l=document.getElementById("btnConfirmBooking");l&&l.addEventListener("click",ct);const c=document.getElementById("btnCloseDetailModal");c&&c.addEventListener("click",_e);const d=document.getElementById("btnCloseWizardModal");d&&d.addEventListener("click",Ie)}async function Ee(e){const t=await ve(e),i=(await oe()).filter(o=>o.billboard_id===e&&o.status!=="Rejected");we=[...t,...i],J()}function Z(){const e=document.getElementById("dateWarningBox");e&&e.classList.remove("active"),J()}async function J(){var g,y;const e=document.getElementById("calMonthTitle"),t=document.getElementById("calendarDaysGrid");if(!t)return;const n=$.getFullYear(),i=$.getMonth(),o=["January","February","March","April","May","June","July","August","September","October","November","December"];e&&(e.textContent=`${o[i]} ${n}`);const a=new Date(n,i,1).getDay(),s=new Date(n,i+1,0).getDate(),r=(g=document.getElementById("bookingStartDate"))==null?void 0:g.value,l=(y=document.getElementById("bookingEndDate"))==null?void 0:y.value,c=r?new Date(r+"T00:00:00").getTime():null,d=l?new Date(l+"T23:59:59").getTime():null;t.innerHTML="";for(let u=0;u<a;u++){const E=document.createElement("div");E.style.height="36px",t.appendChild(E)}for(let u=1;u<=s;u++){const p=new Date(n,i,u).getTime(),I=`${n}-${String(i+1).padStart(2,"0")}-${String(u).padStart(2,"0")}`,f=document.createElement("div");f.textContent=u,f.style.cssText="height: 36px; display: grid; place-content: center; font-weight: 700; border-radius: 8px; font-size: 0.9rem; cursor: pointer; transition: all 0.15s ease; border: 1px solid #E5E7EB;";let D=!1;for(const w of we){const v=new Date(w.start_time||w.start_date).getTime(),m=new Date(w.end_time||w.end_date).getTime();if(!isNaN(v)&&!isNaN(m)&&p>=v&&p<=m){D=!0;break}}if(D)f.style.background="#FECACA",f.style.color="#991B1B",f.style.border="1.5px dashed #EF4444",f.title="This date is already booked.";else{let w=!1;c&&d&&c<=d?p>=c&&p<=d&&(w=!0):c&&p===c&&(w=!0),w?(f.style.background="var(--primary-red)",f.style.color="#FFFFFF",f.style.fontWeight="900",f.style.border="1.5px solid #111"):(f.addEventListener("mouseenter",()=>f.style.borderColor="#111"),f.addEventListener("mouseleave",()=>f.style.borderColor="#E5E7EB")),f.addEventListener("click",()=>{const v=document.getElementById("bookingStartDate"),m=document.getElementById("bookingEndDate");!v.value||v.value&&m.value?(v.value=I,m.value=""):v.value&&!m.value&&(new Date(I)<new Date(v.value)?v.value=I:m.value=I),Z()})}t.appendChild(f)}}function tt(e){F=e,b.billboard_id=e.billboard_id,document.getElementById("detailBillboardId").textContent=e.billboard_id,document.getElementById("detailLocation").textContent=e.location,document.getElementById("detailType").textContent=(e.type||"Unipole").toUpperCase(),document.getElementById("detailSize").textContent=e.size||"W:147 H:43",document.getElementById("detailPrice").textContent=e.price||"$ 1,000",document.getElementById("detailImage").src=e.image_url;const t=document.getElementById("btnMaps360");t&&(t.href=e.maps_url||"https://maps.google.com"),Ee(e.billboard_id);const n=document.getElementById("detailModal");n&&n.classList.add("active")}function _e(){const e=document.getElementById("detailModal");e&&e.classList.remove("active")}function nt(){_e(),Ee(b.billboard_id),V(1);const e=document.getElementById("wizardModal");e&&e.classList.add("active")}function Ie(){const e=document.getElementById("wizardModal");e&&e.classList.remove("active")}function V(e){for(let t=1;t<=4;t++){const n=document.getElementById(`wizardStep${t}`);n&&(n.style.display=t===e?"block":"none")}}async function it(){var o,a;const e=(o=document.getElementById("bookingStartDate"))==null?void 0:o.value,t=(a=document.getElementById("bookingEndDate"))==null?void 0:a.value,n=document.getElementById("dateWarningBox");if(!e||!t){n&&(n.textContent="Please select both start and end dates.",n.classList.add("active"));return}const i=await Ne(b.billboard_id,e,t,F==null?void 0:F.size);if(!i.valid){n&&(n.textContent=i.message||"Unavailable or unsuitable time frame, please choose another",n.classList.add("active"));return}n&&n.classList.remove("active"),b.start_time=new Date(e).toISOString(),b.end_time=new Date(t).toISOString(),V(2)}function ot(){const e=document.getElementById("pdfDropzone"),t=document.getElementById("pdfFileInput");!e||!t||(e.addEventListener("click",()=>t.click()),e.addEventListener("dragover",n=>{n.preventDefault(),e.classList.add("dragover")}),e.addEventListener("dragleave",()=>e.classList.remove("dragover")),e.addEventListener("drop",n=>{n.preventDefault(),e.classList.remove("dragover"),n.dataTransfer.files&&n.dataTransfer.files.length>0&&ue(n.dataTransfer.files[0])}),t.addEventListener("change",n=>{n.target.files&&n.target.files.length>0&&ue(n.target.files[0])}))}async function ue(e){if(e.type!=="application/pdf"&&!e.name.endsWith(".pdf")){alert("Invalid file format. Please upload a PDF file.");return}const t=5*1024*1024;if(e.size>t){alert("File size exceeds 5MB limit. Please upload a smaller PDF file.");return}const n=document.getElementById("dropzoneStatusText");n&&(n.textContent="Uploading PDF brief...");const i=await Pe(e);if(i.success){b.brief_url=i.url,b.brief_filename=i.filename;const o=document.getElementById("pdfFilePreview"),a=document.getElementById("pdfPreviewName");o&&a&&(a.textContent=`${e.name} (${(e.size/(1024*1024)).toFixed(2)} MB)`,o.style.display="flex"),n&&(n.textContent="PDF Uploaded Successfully!")}else alert("Failed to upload PDF file. Please try again."),n&&(n.textContent="Drag & Drop or Upload PDF")}function at(){if(!b.brief_url){alert("Please upload a PDF brief before proceeding.");return}V(3)}function rt(){const e=document.getElementById("extraServicesList");e&&e.querySelectorAll(".service-option-card").forEach(t=>{t.addEventListener("click",()=>{t.classList.toggle("selected");const n=t.getAttribute("data-service");t.classList.contains("selected")?b.extra_services.includes(n)||b.extra_services.push(n):b.extra_services=b.extra_services.filter(i=>i!==n)})})}function st(){lt(),V(4)}function lt(){if(!F)return;document.getElementById("summaryBillboardImg").src=F.image_url,document.getElementById("summaryBillboardId").textContent=F.billboard_id,document.getElementById("summaryLocation").textContent=F.location;const e=new Date(b.start_time).toLocaleDateString("en-US",{month:"short",day:"numeric"}),t=new Date(b.end_time).toLocaleDateString("en-US",{month:"short",day:"numeric"});document.getElementById("summaryDateRange").textContent=`${e} ➔ ${t}`;const n=document.getElementById("summaryServicesList");n&&(b.extra_services.length===0?n.innerHTML='<div style="color: #666; font-style: italic;">No extra services selected.</div>':n.innerHTML=b.extra_services.map(i=>`
      ...
      `).join(""))}async function ct(){const e=S();if(!e){alert("Please sign in to submit your booking request."),_("authSection");return}const t=document.getElementById("btnConfirmBooking");t&&(t.disabled=!0,t.textContent="Submitting Request...");const n={user_email:e.email,billboard_id:b.billboard_id,start_time:b.start_time,end_time:b.end_time,brief_url:b.brief_url,extra_services:b.extra_services},i=await Te(n);t&&(t.disabled=!1,t.textContent="Confirm Request"),i.success?(Ie(),dt("Your request has been received! It will be reviewed and you will be contacted shortly."),ae(),_("dashboardSection")):alert("Failed to submit booking request. Please try again.")}function dt(e){const t=document.getElementById("toastContainer");if(!t)return;const n=document.createElement("div");n.className="toast-message",n.textContent=e,t.appendChild(n),setTimeout(()=>{n.style.opacity="0",n.style.transition="opacity 0.3s ease",setTimeout(()=>n.remove(),300)},5e3)}let z=[],h={searchQuery:"",locations:[],structures:[],availability:[],sizes:[]};async function ut(){if(z=await Y(),console.log("Structure values:",[...new Set(z.map(r=>r.structure))]),!document.getElementById("billboardsGrid"))return;z=await Y(),xe(z);const t=document.getElementById("discoverySearchInput");t&&t.addEventListener("input",r=>{h.searchQuery=r.target.value.toLowerCase().trim(),X()});const n=document.getElementById("btnToggleFilter"),i=document.getElementById("filterModal"),o=document.getElementById("btnCloseFilter"),a=document.getElementById("btnApplyFilter"),s=document.getElementById("btnResetFilter");n&&i&&n.addEventListener("click",()=>i.classList.add("active")),o&&i&&o.addEventListener("click",()=>i.classList.remove("active")),a&&i&&a.addEventListener("click",()=>{mt(),X(),i.classList.remove("active")}),s&&i&&s.addEventListener("click",()=>{pt(),X(),i.classList.remove("active")}),window.addEventListener("authChange",me),me()}function me(){const e=document.getElementById("accessBanner"),t=S();e&&(t&&t.status==="verified"?e.style.display="none":e.style.display="flex")}function mt(){h.locations=Array.from(document.querySelectorAll('input[name="filter_location"]:checked')).map(e=>e.value),h.structures=Array.from(document.querySelectorAll('input[name="filter_structure"]:checked')).map(e=>e.value),h.availability=Array.from(document.querySelectorAll('input[name="filter_availability"]:checked')).map(e=>e.value),h.sizes=Array.from(document.querySelectorAll('input[name="filter_size"]:checked')).map(e=>e.value)}function pt(){document.querySelectorAll('.filter-modal-content input[type="checkbox"]').forEach(e=>{e.checked=!1}),h={searchQuery:h.searchQuery,locations:[],structures:[],availability:[],sizes:[]}}function X(){const e=z.filter(t=>{const n=(t.location||"").toLowerCase(),i=(t.structure||"").toLowerCase(),o=(t.billboard_id||"").toLowerCase(),a=(typeof t.is_available=="boolean"?t.is_available?"available":"unavailable":t.is_available||"").toLowerCase(),s=(t.size||"").replace(/\s+/g,"").toLowerCase();if(h.searchQuery){const r=h.searchQuery,l=o.includes(r),c=n.includes(r),d=i.includes(r);if(!l&&!c&&!d)return!1}return!(h.locations.length>0&&!h.locations.some(l=>n.includes(l.toLowerCase()))||h.structures.length>0&&!h.structures.some(l=>i.includes(l.toLowerCase()))||h.availability.length>0&&!h.availability.some(l=>a.includes(l.toLowerCase()))||h.sizes.length>0&&!h.sizes.some(l=>s.includes(l.replace(/\s+/g,"").toLowerCase())))});xe(e)}const pe=[{key:"megapole",title:"Megapole"},{key:"unipole",title:"Unipole"},{key:"wallbanner",title:"Wallbanner"},{key:"minipole",title:"Minipole"},{key:"backlit",title:"Backlit"},{key:"rooftop",title:"Rooftop"},{key:"bridge",title:"Bridge"},{key:"lightpole banners",title:"Lightpole Banners"}];function gt(e){if(!e)return"other";const t=e.toLowerCase().replace(/[\s\-_]+/g,"");return t.includes("megapole")?"megapole":t.includes("unipole")?"unipole":t.includes("wallbanner")||t.includes("wall")?"wallbanner":t.includes("minipole")?"minipole":t.includes("backlit")?"backlit":t.includes("rooftop")||t.includes("roof")?"rooftop":t.includes("bridge")?"bridge":t.includes("lightpole")||t.includes("polebanner")?"lightpole banners":"other"}function ge(e){const t=e.is_available==="Available"||e.is_available===!0,n=t?"Available":e.is_available===!1?"Unavailable":e.is_available||"Available",i=t?"status-available":"status-soon",o=t?"Book Now":"Check Schedule",a=(e.location||"North Lebanon").split(",")[0];return`
  ...
  `}function xe(e){const t=document.getElementById("billboardsGrid");if(!t)return;if(t.style.display="flex",t.style.flexDirection="column",t.style.gap="40px",e.length===0){t.innerHTML=`
    ...
    `;return}const n={};pe.forEach(o=>{n[o.key]=[]}),n.other={},e.forEach(o=>{const a=gt(o.structure);if(a==="other"){const s=o.structure||"Other Billboard";n.other[s]||(n.other[s]=[]),n.other[s].push(o)}else n[a].push(o)});let i="";pe.forEach(o=>{const a=n[o.key];a&&a.length>0&&(i+=`
    ...
    `,i.appendChild(r)}),i.addEventListener("click",vt)}function vt(e){const t=e.target.closest("[data-toggle-req]");if(t){e.preventDefault();const i=t.dataset.toggleReq,o=decodeURIComponent(t.dataset.full),a=decodeURIComponent(t.dataset.preview),s=document.getElementById(i),r=t.textContent.trim()==="Read more";s.innerHTML=`<strong>Requirements:</strong> ${r?o:a}`,t.textContent=r?"Read less":"Read more";return}const n=e.target.closest("[data-open-cv]");if(n){const i=n.dataset.openCv,o=decodeURIComponent(n.dataset.jobTitle);bt(i,o);return}}function bt(e,t){K=e,document.getElementById("cvModalJobTitle").textContent=t,document.getElementById("cvApplicantName").value="",Se(),Be(),document.getElementById("cvModal").style.display="flex"}function ee(){document.getElementById("cvModal").style.display="none"}function fe(e){if(e){if(e.type!=="application/pdf"){M("Only PDF files are accepted.");return}if(e.size>5*1024*1024){M("File is too large. Maximum size is 5MB.");return}O=e,document.getElementById("cvFileName").textContent=e.name,document.getElementById("cvFilePreview").style.display="flex",document.getElementById("cvDropzoneText").innerHTML='File selected ✓ <span style="color:var(--primary-red,#D72638);text-decoration:underline;">change</span>',Se()}}function Be(){O=null;const e=document.getElementById("cvFileInput");e&&(e.value="");const t=document.getElementById("cvFilePreview");t&&(t.style.display="none");const n=document.getElementById("cvDropzoneText");n&&(n.innerHTML='Drag & drop your CV here, or <span style="color:var(--primary-red,#D72638);text-decoration:underline;">browse</span>')}function M(e){const t=document.getElementById("cvModalError");t&&(t.textContent=e,t.style.display="block")}function Se(){const e=document.getElementById("cvModalError");e&&(e.style.display="none")}async function ht(){const e=x();if(!e){M("Connection unavailable. Please try again.");return}const{error:t}=await e.storage,n=document.getElementById("cvApplicantName").value.trim();if(!n){M("Please enter your full name.");return}if(!O){M("Please upload your CV in PDF format.");return}const i=document.getElementById("btnSendCv");i.textContent="Uploading...",i.disabled=!0;try{const o=`${K}_${Date.now()}_${O.name.replace(/\s+/g,"_")}`,{error:a}=await e.storage.from("cv_careers").upload(o,O,{contentType:"application/pdf",upsert:!1});if(a)throw new Error("CV upload failed: "+a.message);const{data:s}=e.storage.from("cv_careers").getPublicUrl(o),r=(s==null?void 0:s.publicUrl)||o,{error:l}=await e.from("career_applications").insert({role_id:K,applicant_name:n,cv_url:r});if(l)throw new Error("Submission failed: "+l.message);ee(),document.getElementById("cvSuccessModal").style.display="flex"}catch(o){M(o.message||"Something went wrong. Please try again.")}finally{i.textContent="Send Application",i.disabled=!1}}function wt(){var t,n,i,o,a,s;(t=document.getElementById("btnCloseCvModal"))==null||t.addEventListener("click",ee),(n=document.getElementById("cvModal"))==null||n.addEventListener("click",r=>{r.target===r.currentTarget&&ee()}),(i=document.getElementById("btnSendCv"))==null||i.addEventListener("click",ht),(o=document.getElementById("cvFileInput"))==null||o.addEventListener("change",r=>fe(r.target.files[0]));const e=document.getElementById("cvDropzone");e&&(e.addEventListener("dragover",r=>{r.preventDefault(),e.style.background="#FFF0F0",e.style.borderColor="var(--primary-red,#D72638)"}),e.addEventListener("dragleave",()=>{e.style.background="#FAFAFA",e.style.borderColor="#111"}),e.addEventListener("drop",r=>{r.preventDefault(),e.style.background="#FAFAFA",e.style.borderColor="#111",fe(r.dataTransfer.files[0])}),e.addEventListener("click",()=>{var r;return(r=document.getElementById("cvFileInput"))==null?void 0:r.click()})),(a=document.getElementById("cvFilePreview"))==null||a.addEventListener("click",r=>{r.target.closest("button")&&Be()}),(s=document.getElementById("cvSuccessModal"))==null||s.addEventListener("click",r=>{(r.target===r.currentTarget||r.target.closest("button"))&&(document.getElementById("cvSuccessModal").style.display="none")})}window.showPage=function(e){_(e),e==="careers"&&yt()};document.addEventListener("DOMContentLoaded",()=>{Oe(),Re(),He(),Je(),Ve(),Ge(),ke(),ut(),et(),We(),wt();const e=document.querySelectorAll("section"),t=document.querySelectorAll(".nav-item"),n={root:null,threshold:.3},i=new IntersectionObserver(a=>{a.forEach(s=>{if(s.isIntersecting){const r=s.target.getAttribute("id");t.forEach(l=>{const c=l.querySelector("a");c&&c.getAttribute("href")===`#${r}`?l.classList.add("active"):l.classList.remove("active")}),r==="about"||r==="contact"?document.body.classList.add("dark-header"):document.body.classList.remove("dark-header")}})},n);e.forEach(a=>i.observe(a)),"scrollRestoration"in history&&(history.scrollRestoration="manual");const o=window.location.hash?window.location.hash.replace("#",""):"home";o&&["discoverySection","authSection","dashboardSection"].includes(o)?_(o):window.scrollTo(0,0),window.addEventListener("hashchange",()=>{const a=window.location.hash?window.location.hash.replace("#",""):"home";a&&_(a)})});
