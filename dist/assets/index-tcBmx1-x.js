...
${c}`),u=`mailto:${d}?subject=${g}&body=${h}`;window.location.href=u,alert("Thank you! Opening your email client to send your message to ssamadmiryam@gmail.com."),e.reset()}})}const se={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_SUPABASE_ANON_KEY:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5em5saGFoYmxwamN6anptc2N5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNDg5MzQsImV4cCI6MjEwMjcyNDkzNH0.gnVzB1be9lfv2ylqqz6bSLiakv01YwXuXxNVF47VhHA",VITE_SUPABASE_URL:"https://iyznlhahblpjczjzmscy.supabase.co"},Se=typeof import.meta<"u"&&import.meta&&se&&"https://iyznlhahblpjczjzmscy.supabase.co"||"https://iyznlhahblpjczjzmscy.supabase.co",M=Se.replace(/\/rest\/v1\/?$/,"").replace(/\/+$/,""),N=typeof import.meta<"u"&&import.meta&&se&&"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5em5saGFoYmxwamN6anptc2N5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNDg5MzQsImV4cCI6MjEwMjcyNDkzNH0.gnVzB1be9lfv2ylqqz6bSLiakv01YwXuXxNVF47VhHA"||"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5em5saGFoYmxwamN6anptc2N5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNDg5MzQsImV4cCI6MjEwMjcyNDkzNH0.gnVzB1be9lfv2ylqqz6bSLiakv01YwXuXxNVF47VhHA";let q=null;function b(){if(typeof window<"u"&&!q&&window.supabase&&M&&N&&!M.includes("your-supabase-project-id"))try{q=window.supabase.createClient(M,N)}catch(e){console.warn("Supabase initialization warning:",e)}return q}function O(e){return Array.isArray(e)?e.map(t=>{let n=t.price;typeof t.price=="number"?n=`$ ${t.price.toLocaleString()}`:t.price&&!t.price.toString().startsWith("$")&&(n=`$ ${t.price}`);let i=t.is_available;return typeof t.is_available=="boolean"?i=t.is_available?"Available":"Unavailable":t.is_available||(i="Available"),{...t,id:t.id||t.billboard_id,billboard_id:t.billboard_id||`BB-${t.id}`,location:t.location||"Tripoli Entrance & Avenue",maps_url:t.maps_url||"https://maps.google.com/?q=Tripoli,Lebanon",size:t.size||"Standard Size",price:n||"$ 1,000",numericPrice:typeof t.price=="number"?t.price:parseFloat((t.price||"").toString().replace(/[^0-9.]/g,""))||0,image_url:t.image_url||"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80",type:t.structure||"Unipole",is_available:i,available_until:t.available_until||null}}):[]}const Z=[{billboard_id:"U002-A",location:"Bahsas, Tripoli Entrance",maps_url:"https://www.google.com/maps/place/Ad+effect/data=!4m2!3m1!1s0x0:0x1c8a54b37c14fbfc?sa=X&ved=1t:2428&ictx=111",size:"W:147 - H:43",price:"$ 1,000",image_url:"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80",type:"Unipole",is_available:"Available",available_until:null},{billboard_id:"U002-B",location:"Bahsas, Tripoli Entrance",maps_url:"https://maps.google.com/maps?q=34.396779039964066,35.79991279815192",size:"W: 40 - H: 30",price:"$ 1,200",image_url:"https://images.unsplash.com/photo-1568992687947-868a62a9f521?auto=format&fit=crop&w=800&q=80",type:"Unipole",is_available:"Available Soon",available_until:"2026-09-01"},{billboard_id:"P003-C",location:"Mina Road, Tripoli",maps_url:"https://maps.google.com",size:"3:4",price:"$ 600",image_url:"https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=800&q=80",type:"Portrait Billboard",is_available:"Available",available_until:null}];function $(e,t){try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}}function G(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(n){console.error("Error saving local state:",n)}}async function K(){const e=b();if(e)try{const{data:n,error:i}=await e.from("billboards").select("*");if(!i&&n&&n.length>0)return O(n);i&&console.warn("Supabase JS Client error:",i.message)}catch(n){console.warn("Supabase JS Client fetch failed, trying direct REST fetch:",n)}try{const n=await fetch(`${M}/rest/v1/billboards?select=*`,{headers:{apikey:N,Authorization:`Bearer ${N}`}});if(n.ok){const i=await n.json();if(Array.isArray(i)&&i.length>0)return O(i)}else console.warn("Direct REST fetch returned status:",n.status)}catch(n){console.warn("Direct REST fetch exception:",n)}let t=$("adeffect_billboards",null);return t||(G("adeffect_billboards",Z),t=Z),O(t)}async function Le(e){console.log(e.user_name);const t={user_name:e.user_name,business_name:e.business_name,website:e.website||"",phone_number:e.phone_number,email:e.email,location:e.location||"",hear_about_us:e.hear_about_us||[],created_at:new Date().toISOString()},n=b();if(n)try{const{data:i,error:o}=await n.from("pending_users").insert([t]).select();if(!o)return ee(t),{success:!0,data:i};console.warn("Supabase insert pending_users warning:",o)}catch(i){console.warn("Supabase insert pending_users exception:",i)}return ee(t),{success:!0,data:[t]}}function ee(e){const t=$("adeffect_pending_users",[]);t.push(e),G("adeffect_pending_users",t)}async function Ce(e){const t=e.name.split(".").pop(),i=`${`${Date.now()}_${Math.random().toString(36).substring(2,7)}.${t}`}`,o=b();if(o)try{const{data:r,error:s}=await o.storage.from("Briefs of Pending Requests").upload(i,e);if(!s&&r){const{data:l}=o.storage.from("Briefs of Pending Requests").getPublicUrl(i);return{success:!0,url:l.publicUrl,filename:e.name}}console.warn("Supabase Storage upload warning:",s)}catch(r){console.warn("Supabase Storage upload exception:",r)}return{success:!0,url:URL.createObjectURL(e),filename:e.name,isLocalFallback:!0}}async function ke(e){const t=w();if(!document.getElementById("performancesGrid"))return;t&&t.id;const i={user_id:t.id,user_email:e.user_email,billboard_id:e.billboard_id,start_time:e.start_time,end_time:e.end_time,brief_url:e.brief_url,extra_services:e.extra_services||[],status:"In Review",created_at:new Date().toISOString()},o=b();if(o)try{const{data:a,error:r}=await o.from("pending_bookings").insert([i]).select();if(!r)return te(i),{success:!0,data:a};console.warn("Supabase insert pending_bookings warning:",r)}catch(a){console.warn("Supabase insert pending_bookings exception:",a)}return te(i),{success:!0,data:[i]}}function te(e){const t=$("adeffect_pending_bookings",[]);t.unshift(e),G("adeffect_pending_bookings",t)}async function Q(e=null){const t=b();if(t)try{let i=t.from("pending_bookings").select("*");e&&(i=i.eq("user_email",e));const{data:o,error:a}=await i;if(!a&&o)return o}catch(i){console.warn("Supabase fetch pending_bookings error:",i)}const n=$("adeffect_pending_bookings",[]);return e?n.filter(i=>i.user_email===e):n}async function re(e){const t=b();let n=[];if(t)try{let i=t.from("bookings").select("*");e&&(i=i.eq("billboard_id",e));const{data:o,error:a}=await i;!a&&o&&(n=o)}catch(i){console.warn("Supabase fetch bookings error:",i)}if(n.length===0){const i=$("adeffect_confirmed_bookings",[{id:101,client_id:"user-sample-id",billboard_id:"U002-A",start_time:"2026-09-01T00:00:00.000Z",end_time:"2026-09-15T00:00:00.000Z",is_active:!0,created_at:"2026-08-01T00:00:00.000Z"}]);n=e?i.filter(o=>o.billboard_id===e):i}return n}async function De(e,t,n,i=null){const o=new Date(t).getTime(),a=new Date(n).getTime();if(isNaN(o)||isNaN(a)||o>=a)return{valid:!1,message:"Start date must be before end date."};const r=new Date(t),s=new Date(n),l=s.getTime()-r.getTime(),c=Math.round(l/(1e3*60*60*24)),d=(i||"").toString().toLowerCase().replace(/\s+/g,"");if(d.includes("3:4")||d.includes("3x4")||d.includes("3/4")){if(c<7)return{valid:!1,message:"Billboards of size 3:4 require a minimum booking period of 1 week (7 days)."}}else{const m=new Date(r);if(m.setMonth(m.getMonth()+1),c<28&&s<m)return{valid:!1,message:"Billboards must be booked for a minimum period of 1 month."}}const h=await Q(),u=await re(e),_=[...h.filter(m=>m.billboard_id===e&&m.status!=="Rejected"),...u.filter(m=>m.billboard_id===e)];for(const m of _){const S=new Date(m.start_time||m.start_date).getTime(),f=new Date(m.end_time||m.end_date).getTime();if(!isNaN(S)&&!isNaN(f)&&o<=f&&a>=S)return{valid:!1,message:"Selected timeframe overlaps with an existing booking for this billboard. Please choose another date range."}}return{valid:!0}}async function Fe(e=null){const t=b();if(!t||!e)return[];try{const{data:n,error:i}=await t.from("bookings").select("*, billboards(*)").eq("is_active",!0).eq("user_id",e);return i?(console.error("Supabase fetch active bookings error:",i.message),[]):n||[]}catch(n){return console.warn("Supabase fetch active bookings exception:",n),[]}}async function Ae(e,t=null){const n=b();if(n)try{let o=n.from("quotations").select("*");e&&(o=o.eq("client_id",e));const{data:a,error:r}=await o;if(!r&&a)return a}catch(o){console.warn("Supabase fetch quotations error:",o)}return $("adeffect_quotations",[{id:501,created_at:new Date().toISOString(),client_id:e||"client-uuid-001",client_name:"AdEffect Client",media_type:"Outdoor Unipole",media_used:"Backlit Vinyl Print",reference:"U002-A",media_location:"Bahsas, Tripoli Entrance",frequency:1,period:"1 Month (Aug 2026)",printing_cost:250,total_cost_wo_printing:1e3,total_cost_with_printing:1250},{id:502,created_at:new Date(Date.now()-864e5*5).toISOString(),client_id:e||"client-uuid-001",client_name:"AdEffect Client",media_type:"Megapole Network",media_used:"Frontlit Flex Banner",reference:"U002-B",media_location:"Dam & Farz Highway",frequency:2,period:"2 Months (Sep-Oct 2026)",printing_cost:400,total_cost_wo_printing:2400,total_cost_with_printing:2800}])}let T=null;function w(){if(!T){const e=localStorage.getItem("adeffect_auth_user");if(e)try{T=JSON.parse(e)}catch{}}return T}function le(e){T=e,e?localStorage.setItem("adeffect_auth_user",JSON.stringify(e)):localStorage.removeItem("adeffect_auth_user"),window.dispatchEvent(new CustomEvent("authChange",{detail:{user:e}}))}function $e(){const e=document.getElementById("btnGoToDashboard"),t=document.getElementById("btnForgotPassword");t&&t.addEventListener("click",s=>{s.preventDefault(),ze()}),e&&e.addEventListener("click",s=>{s.preventDefault(),Me()});const n=document.getElementById("signUpForm");n&&n.addEventListener("submit",Ne);const i=document.getElementById("signInForm");i&&i.addEventListener("submit",Te);const o=document.getElementById("btnHeaderLogin");o&&o.addEventListener("click",s=>{s.preventDefault(),R("signin")});const a=document.getElementById("btnSwitchToSignUp");a&&a.addEventListener("click",s=>{s.preventDefault(),R("signup")}),new URLSearchParams(window.location.search).get("reset")==="true"&&(v("authSection"),R("signin"),W("You can now set a new password — Supabase handles this via your account settings page.")),v("home")}async function ze(){var n;const e=(n=document.getElementById("signinEmail"))==null?void 0:n.value.trim();if(!e){C('Please enter your email address above, then click "Forgot your password?"');return}const t=b();if(!t){C("Unable to connect. Please try again later.");return}try{const{error:i}=await t.auth.resetPasswordForEmail(e,{redirectTo:window.location.origin+"/?reset=true"});if(i){C(`Could not send reset email: ${i.message}`);return}W("Password reset email sent! Check your inbox and follow the link.")}catch(i){C("Something went wrong. Please try again."),console.error("Forgot password error:",i)}}function Me(){const e=w();e&&e.status==="verified"?v("dashboardSection"):v("authSection")}function R(e){const t=document.getElementById("signUpBox"),n=document.getElementById("signInBox"),i=document.getElementById("btnHeaderLogin");e==="signin"?(t&&(t.style.display="none"),n&&(n.style.display="block"),i&&(i.textContent="SIGN UP")):(t&&(t.style.display="block"),n&&(n.style.display="none"),i&&(i.textContent="LOG IN"))}async function Te(e){var d,g,h;e.preventDefault();const t=(d=document.getElementById("signinEmail"))==null?void 0:d.value.trim(),n=(g=document.getElementById("signinPassword"))==null?void 0:g.value.trim(),i=document.getElementById("signInErrorBox"),o=document.getElementById("signInSuccessBox");if(i&&(i.style.display="none"),o&&(o.style.display="none"),!t||!n){C("Please enter both your email address and password.");return}const a=b();let r=null;if(a)try{const{data:u,error:_}=await a.auth.signInWithPassword({email:t,password:n});if(_){C(`Login failed: ${_.message}`);return}if(u&&u.user){const m=((h=u.user.user_metadata)==null?void 0:h.full_name)||u.user.email.split("@")[0];r={id:u.user.id,email:u.user.email,name:m,status:"verified"}}}catch(u){console.warn("Supabase auth exception, checking demo login fallback:",u)}if(!r)if(t.includes("@")){const u=t.split("@")[0];r={id:"usr_"+Date.now(),email:t,name:u.charAt(0).toUpperCase()+u.slice(1),status:"verified"}}else{C("Invalid email format. Please check your credentials.");return}le(r),W("Login successful! Redirecting to your Client Dashboard...");const s=document.getElementById("dashboardGreetingName");s&&(s.textContent=`Hello, ${r.name}`);const l=document.getElementById("sidebarProfileName");l&&(l.textContent=r.name);const c=document.getElementById("signInForm");c&&c.reset(),setTimeout(()=>{o&&(o.style.display="none"),v("dashboardSection")},1e3)}function C(e){let t=document.getElementById("signInErrorBox");if(!t){const n=document.getElementById("signInForm");n&&(t=document.createElement("div"),t.id="signInErrorBox",t.style.cssText="background: #FEF2F2; border: 2px solid #EF4444; color: #991B1B; padding: 12px 16px; border-radius: 12px; font-weight: 700; font-size: 0.9rem; margin-bottom: 16px;",n.prepend(t))}t?(t.textContent=e,t.style.display="block"):alert(e)}function W(e){let t=document.getElementById("signInSuccessBox");if(!t){const n=document.getElementById("signInForm");n&&(t=document.createElement("div"),t.id="signInSuccessBox",t.style.cssText="background: #DCFCE7; border: 2px solid #16A34A; color: #15803D; padding: 12px 16px; border-radius: 12px; font-weight: 700; font-size: 0.9rem; margin-bottom: 16px;",n.prepend(t))}t?(t.textContent=e,t.style.display="block"):alert(e)}async function Ne(e){var s,l,c,d;e.preventDefault();const t=(s=document.getElementById("signupName"))==null?void 0:s.value.trim(),n=(l=document.getElementById("signupBusiness"))==null?void 0:l.value.trim(),i=(c=document.getElementById("signupEmail"))==null?void 0:c.value.trim(),o=(d=document.getElementById("signupPhone"))==null?void 0:d.value.trim();if(!t||!n||!i||!o){alert("Please fill out all required fields.");return}if((await Le({user_name:t,business_name:n,email:i,phone_number:o})).success){const g=document.getElementById("pendingSuccessModal");g?g.classList.add("active"):(alert("Thank you for registering! Your account registration request is under review."),v("home"))}else alert("Failed to submit registration request.")}function v(e){const t=["home","about","services","projects","contact"],n=["discoverySection","authSection","dashboardSection","careers"];if(e&&e.startsWith("#")&&(e=e.substring(1)),e==="dashboardSection"){const i=w();(!i||i.status!=="verified")&&(e="authSection")}n.includes(e)?(t.forEach(i=>{const o=document.getElementById(i);o&&(o.style.display="none")}),n.forEach(i=>{const o=document.getElementById(i);o&&(i===e?o.style.display=i==="dashboardSection"?"flex":"block":o.style.display="none")}),window.scrollTo({top:0,behavior:"smooth"})):(n.forEach(i=>{const o=document.getElementById(i);o&&(o.style.display="none")}),t.forEach(i=>{const o=document.getElementById(i);o&&(o.style.display="block")}))}let k=[],x=[];function Pe(){window.addEventListener("authChange",ne),ne();const e=document.querySelectorAll(".sidebar-link");e.forEach(r=>{r.addEventListener("click",s=>{s.preventDefault(),e.forEach(c=>c.classList.remove("active")),r.classList.add("active");const l=r.getAttribute("data-tab");Ue(l)})});const t=document.getElementById("sidebarLogoutBtn");t&&t.addEventListener("click",()=>{le(null),v("home")});const n=document.getElementById("btnNewBillboardRequest");n&&n.addEventListener("click",r=>{r.preventDefault(),v("discoverySection")});const i=document.getElementById("btnCloseQuotationModal");i&&i.addEventListener("click",()=>{const r=document.getElementById("quotationModal");r&&r.classList.remove("active")});const o=document.getElementById("btnCloseActiveModal");o&&o.addEventListener("click",()=>{const r=document.getElementById("activeBillboardModal");r&&r.classList.remove("active")});const a=document.getElementById("btnConvertToPDF");a&&a.addEventListener("click",je)}function ne(){const e=w(),t=document.getElementById("dashboardGreetingName"),n=document.getElementById("sidebarProfileName");e?(t&&(t.textContent=`Hello, ${e.name||"Client"}`),n&&(n.textContent=e.name||"Client Account")):(t&&(t.textContent="Hello, Client"),n&&(n.textContent="Client Profile")),ce(),X(),de()}function Ue(e){const t=document.getElementById("dashTabMain"),n=document.getElementById("dashTabRequests"),i=document.getElementById("dashTabActiveBillboards"),o=document.getElementById("dashTabQuotations");t&&(t.style.display="none"),n&&(n.style.display="none"),i&&(i.style.display="none"),o&&(o.style.display="none"),e==="requests"&&n?(n.style.display="block",X()):e==="active"&&i?(i.style.display="block",qe()):e==="quotations"&&o?(o.style.display="block",de()):t&&(t.style.display="block",ce())}async function ce(){const e=w(),t=document.getElementById("performancesGrid");if(!t)return;const n=e?e.id:null;if(x=await Fe(n),!x||x.length===0){t.innerHTML=`
    ...
    `}).join(""),t.querySelectorAll(".active-perf-card").forEach(i=>{i.addEventListener("click",()=>{const o=i.getAttribute("data-booking-id"),a=x.find(r=>String(r.id)===String(o));a&&Oe(a)})})}function qe(){const e=document.getElementById("activeBillboardsGrid");if(e){if(!x||x.length===0){e.innerHTML=`
      <div style="grid-column: 1 / -1; text-align: center; padding: 32px; background: #FFFFFF; border-radius: 16px; border: 2px dashed #ccc;">
  ...
  `,t.classList.add("active")}async function X(){const e=w(),t=document.getElementById("dashboardRequestsTableBody");if(!t)return;const n=e?e.email:null,i=await Q(n);if(!i||i.length===0){t.innerHTML=`
      <tr>
    ...
    `}).join("")}async function de(){const e=w(),t=document.getElementById("quotationsGrid");if(!t)return;const n=e?e.id||e.email:null;if(k=await Ae(n,e?e.email:null),!k||k.length===0){t.innerHTML=`
      <div style="grid-column: 1 / -1; text-align: center; padding: 32px; background: #FFFFFF; border-radius: 16px; border: 2px dashed #ccc;">
  ...
  `,t.classList.add("active")}function je(){window.print()}let B=null,p={billboard_id:"",start_time:"",end_time:"",brief_url:"",brief_filename:"",extra_services:[]},D=new Date,ue=[];function He(){const e=document.getElementById("btnDetailBookNow");e&&e.addEventListener("click",()=>Ve());const t=document.getElementById("bookingStartDate"),n=document.getElementById("bookingEndDate");t&&t.addEventListener("change",H),n&&n.addEventListener("change",H);const i=document.getElementById("calPrevMonth"),o=document.getElementById("calNextMonth");i&&i.addEventListener("click",()=>{D.setMonth(D.getMonth()-1),P()}),o&&o.addEventListener("click",()=>{D.setMonth(D.getMonth()+1),P()});const a=document.getElementById("btnStep1Next");a&&a.addEventListener("click",Ge),Qe();const r=document.getElementById("btnStep2Next");r&&r.addEventListener("click",We),Xe();const s=document.getElementById("btnStep3Next");s&&s.addEventListener("click",Ye);const l=document.getElementById("btnConfirmBooking");l&&l.addEventListener("click",Ke);const c=document.getElementById("btnCloseDetailModal");c&&c.addEventListener("click",pe);const d=document.getElementById("btnCloseWizardModal");d&&d.addEventListener("click",ge)}async function me(e){const t=await re(e),i=(await Q()).filter(o=>o.billboard_id===e&&o.status!=="Rejected");ue=[...t,...i],P()}function H(){const e=document.getElementById("dateWarningBox");e&&e.classList.remove("active"),P()}async function P(){var g,h;const e=document.getElementById("calMonthTitle"),t=document.getElementById("calendarDaysGrid");if(!t)return;const n=D.getFullYear(),i=D.getMonth(),o=["January","February","March","April","May","June","July","August","September","October","November","December"];e&&(e.textContent=`${o[i]} ${n}`);const a=new Date(n,i,1).getDay(),r=new Date(n,i+1,0).getDate(),s=(g=document.getElementById("bookingStartDate"))==null?void 0:g.value,l=(h=document.getElementById("bookingEndDate"))==null?void 0:h.value,c=s?new Date(s+"T00:00:00").getTime():null,d=l?new Date(l+"T23:59:59").getTime():null;t.innerHTML="";for(let u=0;u<a;u++){const _=document.createElement("div");_.style.height="36px",t.appendChild(_)}for(let u=1;u<=r;u++){const m=new Date(n,i,u).getTime(),S=`${n}-${String(i+1).padStart(2,"0")}-${String(u).padStart(2,"0")}`,f=document.createElement("div");f.textContent=u,f.style.cssText="height: 36px; display: grid; place-content: center; font-weight: 700; border-radius: 8px; font-size: 0.9rem; cursor: pointer; transition: all 0.15s ease; border: 1px solid #E5E7EB;";let Y=!1;for(const I of ue){const E=new Date(I.start_time||I.start_date).getTime(),L=new Date(I.end_time||I.end_date).getTime();if(!isNaN(E)&&!isNaN(L)&&m>=E&&m<=L){Y=!0;break}}if(Y)f.style.background="#FECACA",f.style.color="#991B1B",f.style.border="1.5px dashed #EF4444",f.title="This date is already booked.";else{let I=!1;c&&d&&c<=d?m>=c&&m<=d&&(I=!0):c&&m===c&&(I=!0),I?(f.style.background="var(--primary-red)",f.style.color="#FFFFFF",f.style.fontWeight="900",f.style.border="1.5px solid #111"):(f.addEventListener("mouseenter",()=>f.style.borderColor="#111"),f.addEventListener("mouseleave",()=>f.style.borderColor="#E5E7EB")),f.addEventListener("click",()=>{const E=document.getElementById("bookingStartDate"),L=document.getElementById("bookingEndDate");!E.value||E.value&&L.value?(E.value=S,L.value=""):E.value&&!L.value&&(new Date(S)<new Date(E.value)?E.value=S:L.value=S),H()})}t.appendChild(f)}}function Je(e){B=e,p.billboard_id=e.billboard_id,document.getElementById("detailBillboardId").textContent=e.billboard_id,document.getElementById("detailLocation").textContent=e.location,document.getElementById("detailType").textContent=(e.type||"Unipole").toUpperCase(),document.getElementById("detailSize").textContent=e.size||"W:147 H:43",document.getElementById("detailPrice").textContent=e.price||"$ 1,000",document.getElementById("detailImage").src=e.image_url;const t=document.getElementById("btnMaps360");t&&(t.href=e.maps_url||"https://maps.google.com"),me(e.billboard_id);const n=document.getElementById("detailModal");n&&n.classList.add("active")}function pe(){const e=document.getElementById("detailModal");e&&e.classList.remove("active")}function Ve(){pe(),me(p.billboard_id),U(1);const e=document.getElementById("wizardModal");e&&e.classList.add("active")}function ge(){const e=document.getElementById("wizardModal");e&&e.classList.remove("active")}function U(e){for(let t=1;t<=4;t++){const n=document.getElementById(`wizardStep${t}`);n&&(n.style.display=t===e?"block":"none")}}async function Ge(){var o,a;const e=(o=document.getElementById("bookingStartDate"))==null?void 0:o.value,t=(a=document.getElementById("bookingEndDate"))==null?void 0:a.value,n=document.getElementById("dateWarningBox");if(!e||!t){n&&(n.textContent="Please select both start and end dates.",n.classList.add("active"));return}const i=await De(p.billboard_id,e,t,B==null?void 0:B.size);if(!i.valid){n&&(n.textContent=i.message||"Unavailable or unsuitable time frame, please choose another",n.classList.add("active"));return}n&&n.classList.remove("active"),p.start_time=new Date(e).toISOString(),p.end_time=new Date(t).toISOString(),U(2)}function Qe(){const e=document.getElementById("pdfDropzone"),t=document.getElementById("pdfFileInput");!e||!t||(e.addEventListener("click",()=>t.click()),e.addEventListener("dragover",n=>{n.preventDefault(),e.classList.add("dragover")}),e.addEventListener("dragleave",()=>e.classList.remove("dragover")),e.addEventListener("drop",n=>{n.preventDefault(),e.classList.remove("dragover"),n.dataTransfer.files&&n.dataTransfer.files.length>0&&ie(n.dataTransfer.files[0])}),t.addEventListener("change",n=>{n.target.files&&n.target.files.length>0&&ie(n.target.files[0])}))}async function ie(e){if(e.type!=="application/pdf"&&!e.name.endsWith(".pdf")){alert("Invalid file format. Please upload a PDF file.");return}const t=5*1024*1024;if(e.size>t){alert("File size exceeds 5MB limit. Please upload a smaller PDF file.");return}const n=document.getElementById("dropzoneStatusText");n&&(n.textContent="Uploading PDF brief...");const i=await Ce(e);if(i.success){p.brief_url=i.url,p.brief_filename=i.filename;const o=document.getElementById("pdfFilePreview"),a=document.getElementById("pdfPreviewName");o&&a&&(a.textContent=`${e.name} (${(e.size/(1024*1024)).toFixed(2)} MB)`,o.style.display="flex"),n&&(n.textContent="PDF Uploaded Successfully!")}else alert("Failed to upload PDF file. Please try again."),n&&(n.textContent="Drag & Drop or Upload PDF")}function We(){if(!p.brief_url){alert("Please upload a PDF brief before proceeding.");return}U(3)}function Xe(){const e=document.getElementById("extraServicesList");e&&e.querySelectorAll(".service-option-card").forEach(t=>{t.addEventListener("click",()=>{t.classList.toggle("selected");const n=t.getAttribute("data-service");t.classList.contains("selected")?p.extra_services.includes(n)||p.extra_services.push(n):p.extra_services=p.extra_services.filter(i=>i!==n)})})}function Ye(){Ze(),U(4)}function Ze(){if(!B)return;document.getElementById("summaryBillboardImg").src=B.image_url,document.getElementById("summaryBillboardId").textContent=B.billboard_id,document.getElementById("summaryLocation").textContent=B.location;const e=new Date(p.start_time).toLocaleDateString("en-US",{month:"short",day:"numeric"}),t=new Date(p.end_time).toLocaleDateString("en-US",{month:"short",day:"numeric"});document.getElementById("summaryDateRange").textContent=`${e} ➔ ${t}`;const n=document.getElementById("summaryServicesList");n&&(p.extra_services.length===0?n.innerHTML='<div style="color: #666; font-style: italic;">No extra services selected.</div>':n.innerHTML=p.extra_services.map(i=>`
      ...
      `).join(""))}async function Ke(){const e=w();if(!e){alert("Please sign in to submit your booking request."),v("authSection");return}const t=document.getElementById("btnConfirmBooking");t&&(t.disabled=!0,t.textContent="Submitting Request...");const n={user_email:e.email,billboard_id:p.billboard_id,start_time:p.start_time,end_time:p.end_time,brief_url:p.brief_url,extra_services:p.extra_services},i=await ke(n);t&&(t.disabled=!1,t.textContent="Confirm Request"),i.success?(ge(),et("Your request has been received! It will be reviewed and you will be contacted shortly."),X(),v("dashboardSection")):alert("Failed to submit booking request. Please try again.")}function et(e){const t=document.getElementById("toastContainer");if(!t)return;const n=document.createElement("div");n.className="toast-message",n.textContent=e,t.appendChild(n),setTimeout(()=>{n.style.opacity="0",n.style.transition="opacity 0.3s ease",setTimeout(()=>n.remove(),300)},5e3)}let F=[],y={searchQuery:"",locations:[],structures:[],availability:[],sizes:[]};async function tt(){if(F=await K(),console.log("Structure values:",[...new Set(F.map(s=>s.structure))]),!document.getElementById("billboardsGrid"))return;F=await K(),fe(F);const t=document.getElementById("discoverySearchInput");t&&t.addEventListener("input",s=>{y.searchQuery=s.target.value.toLowerCase().trim(),j()});const n=document.getElementById("btnToggleFilter"),i=document.getElementById("filterModal"),o=document.getElementById("btnCloseFilter"),a=document.getElementById("btnApplyFilter"),r=document.getElementById("btnResetFilter");n&&i&&n.addEventListener("click",()=>i.classList.add("active")),o&&i&&o.addEventListener("click",()=>i.classList.remove("active")),a&&i&&a.addEventListener("click",()=>{nt(),j(),i.classList.remove("active")}),r&&i&&r.addEventListener("click",()=>{it(),j(),i.classList.remove("active")}),window.addEventListener("authChange",oe),oe()}function oe(){const e=document.getElementById("accessBanner"),t=w();e&&(t&&t.status==="verified"?e.style.display="none":e.style.display="flex")}function nt(){y.locations=Array.from(document.querySelectorAll('input[name="filter_location"]:checked')).map(e=>e.value),y.structures=Array.from(document.querySelectorAll('input[name="filter_structure"]:checked')).map(e=>e.value),y.availability=Array.from(document.querySelectorAll('input[name="filter_availability"]:checked')).map(e=>e.value),y.sizes=Array.from(document.querySelectorAll('input[name="filter_size"]:checked')).map(e=>e.value)}function it(){document.querySelectorAll('.filter-modal-content input[type="checkbox"]').forEach(e=>{e.checked=!1}),y={searchQuery:y.searchQuery,locations:[],structures:[],availability:[],sizes:[]}}function j(){const e=F.filter(t=>{const n=(t.location||"").toLowerCase(),i=(t.structure||"").toLowerCase(),o=(t.billboard_id||"").toLowerCase(),a=(typeof t.is_available=="boolean"?t.is_available?"available":"unavailable":t.is_available||"").toLowerCase(),r=(t.size||"").replace(/\s+/g,"").toLowerCase();if(y.searchQuery){const s=y.searchQuery,l=o.includes(s),c=n.includes(s),d=i.includes(s);if(!l&&!c&&!d)return!1}return!(y.locations.length>0&&!y.locations.some(l=>n.includes(l.toLowerCase()))||y.structures.length>0&&!y.structures.some(l=>i.includes(l.toLowerCase()))||y.availability.length>0&&!y.availability.some(l=>a.includes(l.toLowerCase()))||y.sizes.length>0&&!y.sizes.some(l=>r.includes(l.replace(/\s+/g,"").toLowerCase())))});fe(e)}function fe(e){const t=document.getElementById("billboardsGrid");if(t){if(e.length===0){t.innerHTML=`
    ...
    `,s.addEventListener("mouseover",()=>{s.style.transform="translate(-2px,-2px)",s.style.boxShadow="7px 7px 0px #111"}),s.addEventListener("mouseout",()=>{s.style.transform="",s.style.boxShadow="5px 5px 0px #111"});const l=r.requirements||"",c=l.length>200,d=c?l.slice(0,200)+"...":l,g=`req-${r.role_id}`;s.innerHTML=`
    ...
    `,i.appendChild(s)}),i.addEventListener("click",st)}function st(e){const t=e.target.closest("[data-toggle-req]");if(t){e.preventDefault();const i=t.dataset.toggleReq,o=decodeURIComponent(t.dataset.full),a=decodeURIComponent(t.dataset.preview),r=document.getElementById(i),s=t.textContent.trim()==="Read more";r.innerHTML=`<strong>Requirements:</strong> ${s?o:a}`,t.textContent=s?"Read less":"Read more";return}const n=e.target.closest("[data-open-cv]");if(n){const i=n.dataset.openCv,o=decodeURIComponent(n.dataset.jobTitle);rt(i,o);return}}function rt(e,t){J=e,document.getElementById("cvModalJobTitle").textContent=t,document.getElementById("cvApplicantName").value="",ve(),ye(),document.getElementById("cvModal").style.display="flex"}function V(){document.getElementById("cvModal").style.display="none"}function ae(e){if(e){if(e.type!=="application/pdf"){A("Only PDF files are accepted.");return}if(e.size>5*1024*1024){A("File is too large. Maximum size is 5MB.");return}z=e,document.getElementById("cvFileName").textContent=e.name,document.getElementById("cvFilePreview").style.display="flex",document.getElementById("cvDropzoneText").innerHTML='File selected ✓ <span style="color:var(--primary-red,#D72638);text-decoration:underline;">change</span>',ve()}}function ye(){z=null;const e=document.getElementById("cvFileInput");e&&(e.value="");const t=document.getElementById("cvFilePreview");t&&(t.style.display="none");const n=document.getElementById("cvDropzoneText");n&&(n.innerHTML='Drag & drop your CV here, or <span style="color:var(--primary-red,#D72638);text-decoration:underline;">browse</span>')}function A(e){const t=document.getElementById("cvModalError");t&&(t.textContent=e,t.style.display="block")}function ve(){const e=document.getElementById("cvModalError");e&&(e.style.display="none")}async function lt(){const e=b();if(!e){A("Connection unavailable. Please try again.");return}const{error:t}=await e.storage,n=document.getElementById("cvApplicantName").value.trim();if(!n){A("Please enter your full name.");return}if(!z){A("Please upload your CV in PDF format.");return}const i=document.getElementById("btnSendCv");i.textContent="Uploading...",i.disabled=!0;try{const o=`${J}_${Date.now()}_${z.name.replace(/\s+/g,"_")}`,{error:a}=await e.storage.from("cv_careers").upload(o,z,{contentType:"application/pdf",upsert:!1});if(a)throw new Error("CV upload failed: "+a.message);const{data:r}=e.storage.from("cv_careers").getPublicUrl(o),s=(r==null?void 0:r.publicUrl)||o,{error:l}=await e.from("career_applications").insert({role_id:J,applicant_name:n,cv_url:s});if(l)throw new Error("Submission failed: "+l.message);V(),document.getElementById("cvSuccessModal").style.display="flex"}catch(o){A(o.message||"Something went wrong. Please try again.")}finally{i.textContent="Send Application",i.disabled=!1}}function ct(){var t,n,i,o,a,r;(t=document.getElementById("btnCloseCvModal"))==null||t.addEventListener("click",V),(n=document.getElementById("cvModal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&V()}),(i=document.getElementById("btnSendCv"))==null||i.addEventListener("click",lt),(o=document.getElementById("cvFileInput"))==null||o.addEventListener("change",s=>ae(s.target.files[0]));const e=document.getElementById("cvDropzone");e&&(e.addEventListener("dragover",s=>{s.preventDefault(),e.style.background="#FFF0F0",e.style.borderColor="var(--primary-red,#D72638)"}),e.addEventListener("dragleave",()=>{e.style.background="#FAFAFA",e.style.borderColor="#111"}),e.addEventListener("drop",s=>{s.preventDefault(),e.style.background="#FAFAFA",e.style.borderColor="#111",ae(s.dataTransfer.files[0])}),e.addEventListener("click",()=>{var s;return(s=document.getElementById("cvFileInput"))==null?void 0:s.click()})),(a=document.getElementById("cvFilePreview"))==null||a.addEventListener("click",s=>{s.target.closest("button")&&ye()}),(r=document.getElementById("cvSuccessModal"))==null||r.addEventListener("click",s=>{(s.target===s.currentTarget||s.target.closest("button"))&&(document.getElementById("cvSuccessModal").style.display="none")})}window.showPage=function(e){v(e),e==="careers"&&at()};document.addEventListener("DOMContentLoaded",()=>{we(),Ee(),Ie(),xe(),Be(),$e(),tt(),He(),Pe(),ct();const e=document.querySelectorAll("section"),t=document.querySelectorAll(".nav-item"),n={root:null,threshold:.3},i=new IntersectionObserver(a=>{a.forEach(r=>{if(r.isIntersecting){const s=r.target.getAttribute("id");t.forEach(l=>{const c=l.querySelector("a");c&&c.getAttribute("href")===`#${s}`?l.classList.add("active"):l.classList.remove("active")}),s==="about"||s==="contact"?document.body.classList.add("dark-header"):document.body.classList.remove("dark-header")}})},n);e.forEach(a=>i.observe(a));const o=window.location.hash?window.location.hash.replace("#",""):"home";o&&["discoverySection","authSection","dashboardSection"].includes(o)&&v(o),window.addEventListener("hashchange",()=>{const a=window.location.hash?window.location.hash.replace("#",""):"home";a&&v(a)})});
