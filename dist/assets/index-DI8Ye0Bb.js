...
${c}`),u=`mailto:${d}?subject=${f}&body=${y}`;window.location.href=u,alert("Thank you! Opening your email client to send your message to ssamadmiryam@gmail.com."),e.reset()}})}let A=[],k=[];function We(){window.addEventListener("authChange",de),de();const e=document.querySelectorAll(".sidebar-link");e.forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),e.forEach(c=>c.classList.remove("active")),s.classList.add("active");const l=s.getAttribute("data-tab");Qe(l)})});const t=document.getElementById("sidebarLogoutBtn");t&&t.addEventListener("click",()=>{te(null),_("home")});const n=document.getElementById("btnNewBillboardRequest");n&&n.addEventListener("click",s=>{s.preventDefault(),_("discoverySection")});const i=document.getElementById("btnCloseQuotationModal");i&&i.addEventListener("click",()=>{const s=document.getElementById("quotationModal");s&&s.classList.remove("active")});const o=document.getElementById("btnCloseActiveModal");o&&o.addEventListener("click",()=>{const s=document.getElementById("activeBillboardModal");s&&s.classList.remove("active")});const a=document.getElementById("btnConvertToPDF");a&&a.addEventListener("click",Ke)}function de(){const e=S(),t=document.getElementById("dashboardGreetingName"),n=document.getElementById("sidebarProfileName");e?(t&&(t.textContent=`Hello, ${e.name||"Client"}`),n&&(n.textContent=e.name||"Client Account")):(t&&(t.textContent="Hello, Client"),n&&(n.textContent="Client Profile")),be(),ae(),he()}function Qe(e){const t=document.getElementById("dashTabMain"),n=document.getElementById("dashTabRequests"),i=document.getElementById("dashTabActiveBillboards"),o=document.getElementById("dashTabQuotations");t&&(t.style.display="none"),n&&(n.style.display="none"),i&&(i.style.display="none"),o&&(o.style.display="none"),e==="requests"&&n?(n.style.display="block",ae()):e==="active"&&i?(i.style.display="block",Xe()):e==="quotations"&&o?(o.style.display="block",he()):t&&(t.style.display="block",be())}async function be(){const e=S(),t=document.getElementById("performancesGrid");if(!t)return;const n=e?e.id:null;if(k=await Ue(n),!k||k.length===0){t.innerHTML=`
  ...
  `}function xe(e){const t=document.getElementById("billboardsGrid");if(!t)return;if(t.style.display="flex",t.style.flexDirection="column",t.style.gap="40px",e.length===0){t.innerHTML=`
    ...
    `;return}const n={};pe.forEach(o=>{n[o.key]=[]}),n.other={},e.forEach(o=>{const a=ft(o.structure);if(a==="other"){const s=o.structure||"Other Billboard";n.other[s]||(n.other[s]=[]),n.other[s].push(o)}else n[a].push(o)});let i="";pe.forEach(o=>{const a=n[o.key];a&&a.length>0&&(i+=`
